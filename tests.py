# Time-stamp: <2015-10-16 22:57:05 marine>
...
print "====================="
print "====================="
print "Test4: avec un dictionnaire comme parametres"
print "====================="
print "====================="
...
sol = ode(systemdiff.systemTest5).set_integrator('dopri5')
sol.set_initial_value(y0, t0)
sol.set_f_params(Parameters)
t1 = 10
dt = 0.1
i = 1
