# Time-stamp: <2015-08-24 11:16:33 marine>
...
def resolutionSystem(y0, t0, tmax, dt, PeT, MX, MP, Veff,gamma, geom="cart",Atol=1.e-10,Rtol=1.e-12):
    ...
    if geom=="cart":
        sol = ode(systemdiff.system_cart).set_integrator('dopri5',atol=Atol,rtol=Rtol,nsteps=1e7)
    elif geom=="spher":
        sol = ode(systemdiff.system_spher).set_integrator('dopri5',atol=Atol,rtol=Rtol,nsteps=1e7)
